...
void CInputDialogArticle::press_ok(void)
{
    ...
    QPushButton * yesButton3=msg3.addButton(QString("Ja"),QMessageBox::YesRole);
    msg3.addButton(QString("Nein"),QMessageBox::NoRole);
    msg3.setWindowTitle("?");
    msg3.setText(s);
        ...
        if(m_pThread->m_pDbInterface!=NULL)
        {
            ...
            else
            {
                ...
                if(m_iMarkId>0)//edit-mode?
                {
                    ...
                    s+=QString(" AND name = '%1'").arg(m_sMarkArticleName);
