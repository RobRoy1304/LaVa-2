...
bool CSettings::create_default_setting_file(void)
{
    ...
    else
    {
        ...
        file.write(s.toAscii());
        s=QString("DLG_UNI_INVENTORY_LIST_TABLE_COLUMNS_WIDTHS#130,160,200,130,130,170\n");
        file.write(s.toAscii());
        s=QString("TABLE_SORT_ORDER_DLG_UNI_INVENTORY_LIST#0,0\n");
        file.write(s.toAscii());

        //dlg balance list
        s=QString("//DLG_BALANCE_LIST\n");
        file.write(s.toAscii());
        s=QString("DLG_BALANCE_LIST_TABLE_COLUMNS_WIDTHS#160,160,160,160,150,150,150,150,150\n");
        file.write(s.toAscii());
