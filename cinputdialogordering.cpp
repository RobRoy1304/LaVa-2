...
{  
    ...
    msg2.setWindowTitle("!");
    msg2.setText("Der Datensatz wurde von einer anderen Programminstanz gelöscht!");

    QMessageBox msg3(QMessageBox::Information,"","");
    msg3.setWindowTitle("!");
    msg3.setText("Artikel aus der Warenliste wurde(n) von einer anderen Programminstanz gelöscht!");
