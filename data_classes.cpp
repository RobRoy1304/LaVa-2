...
bool CTrade::clear(void)
{
    ...
    m_iType=-1;
    m_dtDate=QDate(0,0,0);
    m_sComment=m_sBookingNumber=m_sWares=m_sInfo1=m_sInfo2=m_sInfo3=m_sInfo4=m_sInfo5=QString("");
    return true;
}
...
QString CLogbook::get_output_string(void)
{
    ...
    //-
    s=QString("%1 Uhr - %2 - %3").arg(m_dt_tiDateTime.time().toString("hh:mm:ss"),sType,get_text());
    //-
    return s;
}
