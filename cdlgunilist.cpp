...
bool CDlgUniList::settings(bool bUpdate)
{
    ...
    {
        lsSType.push_back(QString("DLG_UNI_INVENTORY_LIST_TABLE_COLUMNS_WIDTHS"));
        lsSType.push_back(QString("TABLE_SORT_ORDER_DLG_UNI_INVENTORY_LIST"));
    }
    //-
